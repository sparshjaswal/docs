...
**Replication** maintains multiple copies (**replicas**) of the same data across different machines. Where [sharding](./sharding.md) splits data to scale *writes*, replication *copies* data to scale *reads* and survive failures.
