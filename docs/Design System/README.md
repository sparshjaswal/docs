...
flowchart TD
    ...
    D -.-> D1[Data model, sharding,<br/>algorithms, protocols]
...
> **Phase 2 authors: follow these conventions exactly** so every page in this section stays consistent with the rest of the docs.
...
Use fenced **`mermaid`** code blocks for all architecture and flow diagrams (Docusaurus renders them natively). Prefer diagrams over ASCII art:
...
- Link to sibling concept folders with `../folder/README.md`: `[Hashing](../hashing/README.md)`.
- End each page with a back-link footer: `[← Back to System Design](./README.md) · © sparshjaswal`.
...
- [Design Data Structures](../design/README.md) — low-level design building blocks
- [Hashing](../hashing/README.md) — consistent hashing for sharding
- [Heap](../heap/README.md) — priority queues in schedulers and rate limiters
