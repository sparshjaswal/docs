...
> 🔗 See a full, worked **LRU cache implementation** here: [LRU Cache](../lru-cache/README.md).
...
- [LRU Cache](../lru-cache/README.md) — full implementation of the LRU eviction policy
